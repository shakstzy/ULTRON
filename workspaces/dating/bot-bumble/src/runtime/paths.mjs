...
export const CONFIG_DIR = resolve(WORKSPACE_ROOT, "config/bumble");
...
export const PROFILE_DIR = resolve(BOT_ROOT, ".profile");

export const RAW_DIR = resolve(WORKSPACE_ROOT, "raw/bumble");
...
// Reading legacy QUANTUM NDJSON shards in the meantime (mirrors Tinder).
export const IMESSAGE_DIR = "/Users/shakstzy/QUANTUM/raw/imessage";

export const OUTBOUND_DIR = resolve(WORKSPACE_ROOT, "04-outbound/bumble");
...
export const STATE_HOME = resolve(homedir(), ".ultron/dating/bumble");
...
export const DELETED_DIR = resolve(STATE_HOME, "deleted");
