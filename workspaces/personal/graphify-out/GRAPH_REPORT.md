...
8. `Rushil Jha` - 32 edges
9. `LASA (Liberal Arts and Science Academy)` - 29 edges
...
- **Hinge Austin dating connections** —  [EXTRACTED 1.00]
- **USC / LA social circle (Akshar, Abhi, Aggy, Prabhat)** —  [EXTRACTED 1.00]
- **UC Berkeley contacts** — alpin_yukseloglu_uc_berkeley, andy_blockchain_uc_berkeley, ankit_uc_berkeley, ankur_uc_berkeley, aniruth_narayanan_uc_berkeley [INFERRED 0.80]
- **Hinge Austin dating contacts** — ana_hinge_austin, anai_hinge_austin, ananya_hinge_austin, anika_hinge_austin_0555, anika_hinge_austin_4148, anika_hinge_austin, anisha_hinge_austin, anita_hinge_austin, anjali_hinge_austin [INFERRED 0.75]
- **Crypto contacts** — alex_duckworth_crypto, andrew_liutev_crypto, amos_music_crypto_la, andy_blockchain_uc_berkeley [INFERRED 0.75]
- **UC Berkeley contacts** —  [INFERRED 0.75]
- **LA Music Producer contacts** —  [INFERRED 0.70]
- **Hinge Austin matches** —  [INFERRED 0.70]
- **Amsterdam Group Chat** —  [EXTRACTED 1.00]
- **Grad Group Chat (UC Berkeley)** —  [EXTRACTED 1.00]
- **Family Group (Gold Kums Powna AMS)** —  [EXTRACTED 1.00]
- **LASA group chat (Aiden, Alex, Ananya, and more)** —  [EXTRACTED 1.00]
- **LA Rental property coordination group** —  [EXTRACTED 1.00]
- **Austin friends group (Aniruddh, Dravin, Eva, etc.)** —  [EXTRACTED 1.00]
- **Family Group: Arya + Parents + Extended** —  [INFERRED]
- **UC Berkeley Crew: Rushil + Ben + Prabhat** —  [INFERRED]
- **LASA Austin Group** —  [INFERRED]
- **Berkeley Blockchain Group** —  [INFERRED 0.80]
- **LA Music Producer Circle** —  [INFERRED 0.80]
- **Austin Friend Group** —  [INFERRED 0.75]
- **LA Producers Circle** —  [INFERRED 0.75]
- **UC Berkeley Mo Crew** —  [INFERRED 0.80]
- **Prescription LA Group** —  [INFERRED 0.75]
- **Unkal UC Berkeley friend group** —  [EXTRACTED 1.00]
- **Intervention 4 Shakti group** —  [EXTRACTED 1.00]
- **LA music producer group - Peter Tyler Yosef** —  [EXTRACTED 1.00]
- **LA Music Producers/Artists** —  [INFERRED]
- **Austin Hinge Dates** —  [INFERRED]
- **UC Berkeley Contacts** —  [INFERRED]
- **LASA Contacts** —  [INFERRED 0.75]
- **UC Berkeley Contacts** —  [INFERRED 0.75]
- **Silver Lining LA Contacts** —  [INFERRED 0.75]
- **Amsterdam Trip 2024** —  [EXTRACTED 1.00]
- **Adithya's LA Rental Property** —  [EXTRACTED 1.00]
- **Brick City Mob — Music Recording Sessions** —  [EXTRACTED 1.00]
- **Pseu Crew (Adarsh, Prabhat, Saif, Rushil, Adithya)** —  [EXTRACTED 1.00]
- **Seedbox Labs working group (Avery, Abraham, Adithya)** —  [EXTRACTED 1.00]
- **Family Group (Adithya, Dad, Mom, Arya)** —  [EXTRACTED 1.00]
- **Core friend group: Adarsh, Prabhat, Rushil, Saif** —  [EXTRACTED 1.00]
- **Klein Ct household: Amadeus, Evan, Angel, John, Zubair, Austin** —  [EXTRACTED 1.00]
- **Klein Ct roommates Dec 2024** —  [INFERRED]
- **Berkeley hangout group May 2025** —  [INFERRED]
- **Klein property purchase team 2024** —  [INFERRED]
- **Prescription Songs team working with Adithya** —  [EXTRACTED 1.00]
- **Sylmar house residents** —  [INFERRED 0.90]
- **Brennan Noah Sam friend group** —  [EXTRACTED 1.00]
- **Klein Court property management group** —  [INFERRED]
- **Music collaboration group (caitlin-ryan)** —  [INFERRED]
- **Cameron AI voice project group** —  [INFERRED]
- **Berkeley friends Austin Halloween 2025** —  [EXTRACTED 1.00]
- **Music studio session group Oct 2025** —  [EXTRACTED 1.00]
- **Music team: Keith, Ryan, Tyler + Adithya** —  [INFERRED]
- **Austin hangout: Griffin, Noah Bailie, Nikhil + Adithya** —  [INFERRED]
- **Studio session: Louie, Tyler, Yosef + Adithya** —  [INFERRED]
- **NYC crew (Mo, Vihan, Shlok + Adithya)** —  [EXTRACTED 1.00]
- **Austin dinner crew (Adithya, Nikhil, Parth, Noah)** —  [EXTRACTED 1.00]
- **Power Kinetics team (Mychal, Adithya CEO, Brian, Marvin)** —  [EXTRACTED 1.00]
- **Noah-Sam-Adithya friend group** —  [INFERRED]
- **Pseuhas-Rushil-Saif NYC group** —  [INFERRED]
- **Prabhat-Rushil-Saif group** —  [INFERRED]
- **Music collaboration: Ain't Love / Never Been Good At Goodbyes** —  [EXTRACTED 1.00]
- **intervention-4-shakti core (Shervin, Suhas, Rushil, Adithya)** —  [EXTRACTED 1.00]
- **swol-patrol LA group (Adithya, Evan, Filip, Amadeus)** —  [EXTRACTED 1.00]
- **unkal group chat members** — adithya, saif_ali_nyc, maneesh_uc_berkeley, rushil_jha_uc_berkeley_nyc, prabhat, ethan, ashank, safwan_uc_berkeley, zach [EXTRACTED 1.00]
- **xx group chat / Miami planning** — adithya, rishika_uc_berkeley, nidhi [EXTRACTED 1.00]
- **NYC social / crypto scene Aug 2025** — adithya, abraham_crypto_lightnodeventures_la, abhi_usc_akshar_la [INFERRED 0.70]
- **Adarsh-Saif Bay Area friend group** —  [INFERRED]
- **USC friends in NYC (Akshar, Aggy)** —  [INFERRED 0.80]
- **Pi Kapp Berkeley friend group (Alec, Ash)** —  [INFERRED]
- **Sylmar Property Residents** —  [INFERRED]
- **LASA Friends (Austin)** —  [INFERRED 0.80]
- **UC Berkeley Friends** —  [INFERRED 0.80]
- **Seedbox NIH Grant Collaboration** —  [INFERRED]
- **Music collab sessions at Sylmar studio (2024)** —  [EXTRACTED 1.00]
- **Sub Focus concert Shrine LA Oct 2025** —  [EXTRACTED 1.00]
- **Austin music crew hangouts** —  [EXTRACTED 1.00]
- **LASA Jan 2025 Dinner (1822 S Congress)** —  [EXTRACTED 1.00]
- **Klein property tenants group** —  [EXTRACTED 1.00]
- **Berkeley Friend Group (Adithya, Edwin, Divyesh)** —  [INFERRED 0.80]
- **UC Berkeley friend group** —  [INFERRED 0.80]
- **LASA Austin crew (Jan 2025 dinner)** —  [EXTRACTED 1.00]
- **Klein Court roommates (Adithya, Evan, Amadeus)** —  [INFERRED]
- **LA social circle: Adithya, Evan, Filip** —  [INFERRED]
- **Hunter + Adithya at 6th Street Halloween 2025** —  [EXTRACTED 1.00]
- **Crypto/Blockchain LA Scene** —  [INFERRED]
- **NYC Nightlife Crew (Feb 2025)** —  [INFERRED]
- **Eclipse Audio Data Deal** —  [INFERRED]
- **LASA homies dinner Austin Jan 2025** —  [INFERRED]
- **LASA homies dinner Jan 2025 (1822 S Congress, Austin)** —  [EXTRACTED 1.00]
- **UC Berkeley friend group (three idiots)** —  [EXTRACTED 1.00]
- **NYC bar nights (La Caverna, LES)** —  [EXTRACTED 1.00]
- **Nova team collaborating with Adithya on Synapse/Outerscope** —  [EXTRACTED 1.00]
- **LASA Austin friend group** —  [INFERRED 0.80]
- **Nvidia GTC 2026 SJ meetup** —  [INFERRED]
- **Klein Court property team** —  [INFERRED]
- **** — adithya, mychal_kendricks, filip [EXTRACTED 1.00]
- **LASA Homies Dinner Jan 2025** —  [EXTRACTED 0.90]
- **LASA Core Friend Group** —  [EXTRACTED 0.90]
- **UC Berkeley friend group** —  [INFERRED 0.85]
- **Pseuhas puja / Berkeley friend group hangout Aug 2025** — adithya, pseuhas_uc_berkeley_nyc, rue [INFERRED 0.80]
- **Vegas trip Mar 2025** —  [INFERRED]
- **Amsterdam Trip March 2024** —  [INFERRED]
- **UC Berkeley Social Circle** —  [INFERRED]
- **Beyond Wonderland Festival 2025** —  [INFERRED]
- **NYC Crypto Social Events Jun 2025** — adithya, rushil_jha, saif [INFERRED 0.80]
- **Ryan UT + Adithya bar nights on 6th Street Austin** —  [INFERRED]
- **Ryan UT + Adithya at SXSW 2026 events** —  [INFERRED]
- **UC Berkeley Alumni — Adithya, Saif, Safwan** —  [EXTRACTED 1.00]
- **Sam Garcia, Jake, Noah, Adithya Austin hangout (Mar 2026)** —  [EXTRACTED 1.00]
- **Music session at Shanks' Hollywood studio (Mar 2024)** —  [INFERRED 0.70]
- **ETHDenver 2025 attendance** —  [EXTRACTED 1.00]
- **Rozco's Comedy Club night out (May 2026)** —  [EXTRACTED 1.00]
- **UC Berkeley contacts** —  [INFERRED 0.75]
- **Nvidia GTC 2026 Bay Area meetups** —  [INFERRED 0.75]
- **a16z interview prep circle** —  [INFERRED 0.80]
- **NVIDIA GTC 2026 — Adithya + Sydney** —  [INFERRED]
- **LASA homies dinner Austin Jan 2025** —  [EXTRACTED 1.00]
- **Tyler Sheppard music collab network (adithya, tyler_sheppard, yosef, trey)** —  [INFERRED 0.80]
- **Vihan + Mo + Adithya NYC hangout (Feb 2025)** —  [EXTRACTED 1.00]
- **Adithya + Xanos at Consensus Toronto 2025** —  [EXTRACTED 1.00]
- **Adithya + Wes + Tyler Perry Studios AI vocal model project** —  [EXTRACTED 1.00]
...
Cohesion: 1.0
Nodes (1): Abi (Anna / SpaceX)

### Community 63 - "Community 63"
Cohesion: 1.0
Nodes (1): Ayush (Blockchain, UC Berkeley)
